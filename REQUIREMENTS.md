...
| FR-1.11d | It is YAML in canonical form, emitted by hand. Every structured file in the ecosystem is YAML, and a flat mapping of scalars needs no library to write correctly, so the guarantee in FR-1.11c is kept rather than traded for a third-party import. | [D] |
