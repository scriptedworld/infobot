...
| FR-1.11n | 2026-08-27 | The form pinned independently at both ends, infobot's output being a fixture in wrench and infobot asserting its own canonical form. It existed only because two programs emitted the same bytes by agreement rather than by sharing code. Linking the library makes it one library with one test. Retired on the same measurement as FR-1.11d. |
